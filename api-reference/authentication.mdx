...
<Tabs>
  <Tab title="House Helper Registration">
    <CodeGroup>
    ```javascript JavaScript
    // Legacy endpoint - use basic registration + onboarding instead
    const formData = new FormData();
    ...
    // House helper specific required fields
    formData.append('job_type', 'full_time');
    ...
    // Optional fields
    formData.append('username', 'jane_helper');
    formData.append('nationality', 'Kenyan');

    const response = await fetch('https://api.mdadda.com/api/v1/auth/register/', {
      method: 'POST',
      body: formData
    });
    ...
    url = "https://api.mdadda.com/api/v1/auth/register/"
    ...
    ```bash cURL
    curl -X POST https://api.mdadda.com/api/v1/auth/register/ \
  ...
  <Tab title="House Holder Registration">
    ...
    formData.append('dob', '1985-03-20');
    formData.append('phone_number', '+254701234567');
    ...
    // Optional fields
    formData.append('username', 'john_household');
    formData.append('nationality', 'Kenyan');
    ...
    data = {
        ...
        # House holder specific
        "household_size": 4,

        # Optional
        "username": "john_household",
        "nationality": "Kenyan"
    }
    ...
    curl -X POST https://api.mdadda.com/api/v1/auth/register/ \
      ...
      -F "last_name=Smith" \
      -F "dob=1985-03-20" \
      -F "phone_number=+254701234567" \
      -F "role=house_holder" \
      -F "household_size=4" \
      -F "username=john_household" \
      -F "nationality=Kenyan"
    ```
    </CodeGroup>
  </Tab>
